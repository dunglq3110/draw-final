...
var paper = function (t, e) {
			...
			function t(t, e, r, s, a) {
				function u(i, u) {
					(u = u || ((u = o(e, i)) && (u.get ? u : u.value))),
						"string" == typeof u && "#" === u[0] && (u = t[u.substring(1)] || u);
					var c,
						f = "function" == typeof u,
						d = u,
					...
					(a && _) ||
						...
						(d && !f && d.get && "function" == typeof d.get && n.isPlainObject(d)) ||
							(d = { value: d, writable: !0 }),
						(o(t, i) || { configurable: !0 }).configurable &&
							((d.configurable = !0), (d.enumerable = r)),
						h(t, i, d));
				}
				var l = {};
				if (e) {
				...
				n,
				{
					...
					extend: function () {
						...
						return (
							...
							h(n, "constructor", { value: e, writable: !0, configurable: !0 }),
							t(e, this, !0),
		...
		r.inject({
			...
			statics: {
				...
				read: function (t, n, i, s) {
					...
					return (
						(s = s || l - u),
						c instanceof this || (i && i.readNull && null == c && s <= 1)
							? (h && (t.__index = u + 1), c && i && i.clone ? c.clone() : c)
							: ((c = r.create(o)),
							  h && (c.__read = !0),
							  (c = c.initialize.apply(c, u > 0 || u + s < l ? r.slice(t, u, u + s) : t) || c),
							  h && ((t.__index = u + c.__read), (c.__read = e)),
							  c)
					);
				},
				peek: function (t, e) {
				...
				getNamed: function (t, n) {
					var i = t[0];
					if (
						(t._hasObject === e && (t._hasObject = 1 === t.length && r.isPlainObject(i)),
						t._hasObject)
					)
						return n ? i[n] : t._filtered || i;
				},
	...
	var s = {
			on: function (t, e) {
				if ("string" != typeof t)
					...
					(s = s[t] = s[t] || []),
						s.indexOf(e) === -1 &&
							(s.push(e), i && i.install && 1 === s.length && i.install.call(this, t));
				}
				return this;
			},
			off: function (t, e) {
				...
				return (
					a &&
						(!e || ((n = a.indexOf(e)) !== -1 && 1 === a.length)
							? (s && s.uninstall && s.uninstall.call(this, t), delete this._callbacks[t])
							: n !== -1 && a.splice(n, 1)),
					this
				);
			},
		...
		a = r.extend({
			...
			clear: function () {
				for (
					var t = this.projects, e = this.tools, n = this.palettes, i = t.length - 1;
					i >= 0;
					i--
				)
					t[i].remove();
	...
	var u = new (function () {
			...
			return {
				...
				solveQuadratic: function (i, r, o, h, u, f) {
					...
					var y = 0,
						...
						b = f + l;
					return (
						isFinite(d) && (w || (d > x && d < b)) && (h[y++] = w ? d : t(d, u, f)),
						_ !== d && isFinite(_) && (w || (_ > x && _ < b)) && (h[y++] = w ? _ : t(_, u, f)),
						y
					);
				},
					...
					return (
						...
						(t &&
							((this.width === t.width && this.height === t.height) ||
								(Array.isArray(t) && this.width === t[0] && this.height === t[1]))) ||
						!1
					);
				},
				clone: function () {
		...
		g = r.extend(
			{
						...
						("number" === o
							...
							: 1 === arguments.length &&
							  (Array.isArray(t)
									...
									: t.x !== e || t.width !== e
									? (this._set(t.x || 0, t.y || 0, t.width || 0, t.height || 0), (a = 1))
									: t.from === e &&
									  t.to === e &&
				...
				setRight: function (t) {
					this._fixX !== e && 1 !== this._fixX && (this._fixW = 0),
						this._fixW ? (this.x = t - this.width) : (this.width = t - this.x),
						(this._fixX = 1);
				},
				getBottom: function () {
				...
				setBottom: function (t) {
					this._fixY !== e && 1 !== this._fixY && (this._fixH = 0),
						this._fixH ? (this.y = t - this.height) : (this.height = t - this.y),
						(this._fixY = 1);
				},
				getCenterX: function () {
				...
				contains: function (t) {
					return (t && t.width !== e) || 4 === (Array.isArray(t) ? t : arguments).length
				...
				_containsPoint: function (t) {
					var e = t.x,
						n = t.y;
					return (
						e >= this.x && n >= this.y && e <= this.x + this.width && n <= this.y + this.height
					);
				},
		...
		p = r.extend(
			{
				...
				initialize: function ot(t, e) {
					...
					if (
						(n >= 6
							...
							: 1 === n || 2 === n
							? t instanceof ot
								? this._set(t._a, t._b, t._c, t._d, t._tx, t._ty, e)
								: Array.isArray(t)
				...
				_transformPoint: function (t, e, n) {
					...
					return (
						e || (e = new c()),
						e._set(i * this._a + r * this._c + this._tx, i * this._b + r * this._d + this._ty, n)
					);
				},
				...
				_transformBounds: function (t, e, n) {
					for (
						var i = this._transformCorners(t), r = i.slice(0, 2), s = r.slice(), a = 2;
						a < 8;
						a++
					) {
						var o = i[a],
		...
		m = r.extend({
			...
			initialize: function (t, e, n, i, r) {
				var s = !1;
				arguments.length >= 4
					? ((this._px = t), (this._py = e), (this._vx = n), (this._vy = i), (s = r))
					: ((this._px = t.x), (this._py = t.y), (this._vx = e.x), (this._vy = e.y), (s = n)),
				...
				intersect: function (t, e, n, i, r, s, a, o, h, l) {
					...
					if (!u.isZero(f)) {
						...
						if (l || (m < g && g < y && m < v && v < y))
							return l || (g = g <= 0 ? 0 : g >= 1 ? 1 : g), new c(t + g * n, e + g * i);
					}
				},
			...
			_insertItem: function (t, n, i) {
				return (
					(n =
						...
						(this._activeLayer || this._insertItem(e, new b(w.NO_INSERT), !0)).insertChild(t, n)),
		...
		w = r.extend(
			...
			})(),
			{
				...
				_initialize: function (t, n) {
					...
					return (
						...
						s || (i && t.insert === !1) || (!h.insertItems && (!i || t.insert !== !0))
							? this._setProject(o)
							: ((i && t.parent) || o)._insertItem(e, this, !0),
						i &&
							t !== w.NO_INSERT &&
							this.set(t, { internal: !0, insert: !0, project: !0, parent: !0 }),
						i
					);
				},
				_serialize: function (t, e) {
					function n(n) {
						for (var a in n) {
							var o = s[a];
							r.equals(o, "leading" === a ? 1.2 * n.fontSize : n[a]) ||
			...
			r.each(
				...
				},
				{
					...
					setBounds: function () {
						...
						i.translate(r),
							(t.width == e.width && t.height == e.height) ||
								(n.isInvertible() ||
									(n.set(n._backup || new p().translate(n.getTranslation())),
									(e = this.getBounds())),
								i.scale(
					...
					_getBounds: function (t, e) {
						...
						return n && n.length
							? (w._updateBoundsCache(this, e.cacheItem), w._getBounds(n, t, e))
							: new g();
					},
					_getCachedBounds: function (t, e) {
						...
						var n = e.internal,
							...
							s =
								i &&
								(!t || t.equals(r)) &&
								[e.stroke ? 1 : 0, e.handle ? 1 : 0, n ? 1 : 0].join("");
						if (
							(w._updateBoundsCache(this._parent || this._symbol, i),
							s && this._bounds && s in this._bounds)
						)
							return this._bounds[s].rect.clone();
						...
						_clearBoundsCache: function (t) {
							...
							if (n) {
								...
								for (var i = 0, r = n.list, s = r.length; i < s; i++) {
									var a = r[i];
									a !== t &&
										((a._bounds = a._position = e), a._boundsCache && w._clearBoundsCache(a));
								}
							}
						},
						_getBounds: function (t, e, n) {
							...
							for (var o = 0, h = t.length; o < h; o++) {
								...
								if (u._visible && !u.isEmpty()) {
									...
									(i = Math.min(l.x, i)),
										(s = Math.min(l.y, s)),
										(r = Math.max(l.x + l.width, r)),
										(a = Math.max(l.y + l.height, a));
								}
							}
			...
			},
			{
				...
				copyAttributes: function (t, e) {
					...
					for (
						var n = ["_locked", "_visible", "_blendMode", "_opacity", "_clipMask", "_guide"],
							i = 0,
							s = n.length;
						i < s;
						i++
				...
				intersects: function (t, e) {
					return (
						t instanceof w &&
						this._asPathItem().getIntersections(t._asPathItem(), null, e, !0).length > 0
					);
				},
			},
			new (function () {
				...
				_hitTest: function (t, e, n) {
					...
					function s(e, n) {
						...
						if (t.subtract(i).divide(u).length <= 1)
							return new P(e, g, { name: r.hyphenate(n), point: i });
					}
								...
								(f &&
									i(
										this._hitTestSelf(
											...
											e,
											o,
											this.getStrokeScaling() ? null : o.inverted()._shiftless()
										)
									)) ||
								null),
					...
					_getItems: function ct(t, e, n, i, s) {
						...
						for (var d = 0, _ = c && c.length; d < _; d++) {
							...
							if (l) {
								...
								l.contains(u) ||
									(i.overlapping && (u.contains(l) || i.path.intersects(v, m))) ||
									(y = !1);
							}
			...
			},
			{
				...
				_removeNamed: function () {
					...
					if (t) {
						...
						s !== -1 &&
							(e[i] == this && delete e[i], r.splice(s, 1), r.length ? (e[i] = r[0]) : delete n[i]);
					}
				},
				_remove: function (t, e) {
					...
					return (
						...
						null != s &&
							(i._activeLayer === this &&
								(i._activeLayer = this.getNextSibling() || this.getPreviousSibling()),
				...
				removeChildren: function (t, e) {
					...
					for (var n = r.splice(this._children, null, t, e - t), i = n.length - 1; i >= 0; i--)
						n[i]._remove(!0, !1);
					...
					transform: function (t, e, n, i) {
						...
						if (
							(t &&
								...
								r.prepend(t)),
							(s = s && this._transformContent(r, n, i)))
						) {
							var a = this._pivot,
								o = this._style,
								h = o.getFillColor(!0),
								u = o.getStrokeColor(!0);
							a && r._transformPoint(a, a, !0),
								h && h.transform(r),
								u && u.transform(r),
								r.reset(!0),
			...
			),
			{
				_setStyles: function (t, e, n) {
					...
					if ((i.hasFill() && (t.fillStyle = i.getFillColor().toCanvasStyle(t)), i.hasStroke())) {
						(t.strokeStyle = i.getStrokeColor().toCanvasStyle(t)),
						...
						if (
							...
							o &&
								o.length &&
								("setLineDash" in t
									? (t.setLineDash(o), (t.lineDashOffset = h))
									: ((t.mozDash = o), (t.mozDashOffset = h)));
						}
					}
					if (i.hasShadow()) {
				...
				draw: function (t, e, n) {
					...
					if (this._visible && 0 !== this._opacity) {
						...
						if (o.isInvertible()) {
							(s = s ? s.appended(o) : o),
								r.push(o),
								e.updateMatrix && ((o._updateVersion = i), (this._globalMatrix = o));
							var h,
								u,
								l,
								c = this._blendMode,
							...
							if (!g) {
								...
								(l = e.offset),
									...
									(h = t),
									(t = tt.getContext(p.getSize().ceil().add(1).multiply(v))),
									1 !== v && t.scale(v, v);
							}
							t.save();
							...
							this._draw(t, e, s, m),
								...
								g ||
									(et.process(c, t, h, f, u.subtract(l).multiply(v)),
									tt.release(t),
									(e.offset = l));
						}
					}
				...
				_isUpdated: function (t) {
					...
					return (
						!n && e && e._visible && e._isUpdated(t) && ((this._updateVersion = t), (n = !0)), n
					);
				},
				_drawSelection: function (t, e, n, i, r) {
					...
					if ((this._drawSelected || (a = !1), (a || o || h) && this._isUpdated(r))) {
						var u,
							...
							f = n / 2;
						if (
							((t.strokeStyle = t.fillStyle = l ? l.toCanvasStyle(t) : "#009dec"),
		...
		x = w.extend({
			...
			_getBounds: function dt(t, e) {
				...
				return n
					? n._getCachedBounds(t && t.appended(n._matrix), r.set({}, e, { stroke: !1 }))
		...
		C = w.extend(
			{
				...
				_getBounds: function (t, e) {
					...
					return (
						...
						r ? n.expand(L._getStrokePadding(r, this._getStrokeMatrix(t, e))) : n
					);
				},
			},
			new (function () {
				...
				function e(t, e, n, i) {
					var r = t.divide(e);
					return (
						(!i || r.isInQuadrant(i)) && r.subtract(r.normalize()).multiply(e).divide(n).length <= 1
					);
				}
				return {
					_contains: function n(e) {
						if ("rectangle" === this._type) {
							var i = t(this, e);
							return i
								? e.subtract(i.point).divide(this._radius).getLength() <= 1
								: n.base.call(this, e);
						}
					...
					return {
						...
						_readEllipse: function (t) {
							...
							if (r.hasNamed(t, "radius"))
								(e = c.readNamed(t, "center")), (n = d.readNamed(t, "radius"));
							else {
		...
		S = w.extend(
			...
			},
			{
				...
				getSubCanvas: function () {
					...
					return (
						e.drawImage(this.getCanvas(), t.x, t.y, t.width, t.height, 0, 0, t.width, t.height),
						e.canvas
					);
				},
				...
				getAverageColor: function (t) {
					...
					var i = 32,
						...
						o = S._sampleContext;
					o ? o.clearRect(0, 0, i + 1, i + 1) : (o = S._sampleContext = tt.getContext(new d(i))),
						o.save();
					...
					for (
						var c = o.getImageData(0.5, 0.5, Math.ceil(s), Math.ceil(a)).data,
							f = [0, 0, 0],
							_ = 0,
							v = 0,
							m = c.length;
		...
		A = r.extend({
			...
			initialize: function (t, n, i, r, s, a) {
				...
				c > 0 &&
					(null == t || "object" == typeof t
						? 1 === c && t && "point" in t
							? ((o = t.point), (h = t.handleIn), (u = t.handleOut), (l = t.selection))
							: ((o = t), (h = n), (u = i), (l = r))
						: ((o = [t, n]), (h = i !== e ? [i, r] : null), (u = s !== e ? [s, a] : null))),
					new M(o, this, "_point"),
				...
				if (e) {
					...
					i &&
						((t && t !== this._point && t !== this._handleIn) ||
							!(n = r > 0 ? i[r - 1] : e._closed ? i[i.length - 1] : null) ||
							n._changed(),
			...
			setSelection: function (t) {
				...
				(this._selection = t = t || 0),
					n && t !== e && (n._updateSelection(this, e, t), n._changed(129));
			},
			changeSelection: function (t, e) {
				var n = this._selection;
				this.setSelection(e ? n | t : n & ~t);
			...
			getCurve: function () {
				var t = this._path,
					e = this._index;
				return t
					? (e > 0 && !t._closed && e === t._segments.length - 1 && e--, t.getCurves()[e] || null)
					: null;
			},
			...
			interpolate: function (t, e, n) {
				...
				this._point._set(i * s._x + r * a._x, i * s._y + r * a._y, !0),
					this._handleIn._set(i * o._x + r * h._x, i * o._y + r * h._y, !0),
					this._handleOut._set(i * l._x + r * u._x, i * l._y + r * u._y, !0),
					this._changed();
			},
			_transformCoordinates: function (t, e, n) {
				var i = this._point,
		...
		T = r.extend(
			{
				...
				initialize: function (t, e, n, i, r, s, a, o) {
					...
					3 === _
						...
						? 1 === _
							? "segment1" in t
								? ((h = new A(t.segment1)), (u = new A(t.segment2)))
								: "point1" in t
								? ((l = t.point1), (f = t.handle1), (d = t.handle2), (c = t.point2))
								: Array.isArray(t) &&
								  ((l = [t[0], t[1]]),
								  (c = [t[6], t[7]]),
								  (f = [t[2] - t[0], t[3] - t[1]]),
							...
							: 4 === _
							? ((l = t), (f = e), (d = n), (c = i))
							: 8 === _ && ((l = [t, e]), (c = [a, o]), (f = [n - t, i - e]), (d = [r - a, s - o]))
						: ((h = new A()), (u = new A())),
				...
				getPrevious: function () {
					var t = this._path && this._path._curves;
					return (
						(t && (t[this._segment1._index - 1] || (this._path._closed && t[t.length - 1]))) || null
					);
				},
				isFirst: function () {
					return !this._segment1._index;
			...
			},
			{
				getLength: function () {
					return (
						null == this._length && (this._length = T.getLength(this.getValues(), 0, 1)),
						this._length
					);
				},
				getArea: function () {
				...
				divideAtTime: function (t, e) {
					...
					if (t >= n && t <= i) {
						...
						f
							...
							: ((this._segment2 = g), this._changed(), (r = new T(g, l)));
					}
					return r;
				},
				splitAt: function (t) {
				...
				divide: function (t, n) {
					return this.divideAtTime(t === e ? 0.5 : n ? t : this.getTimeAt(t));
				},
				split: function (t, n) {
					return this.splitAtTime(t === e ? 0.5 : n ? t : this.getTimeAt(t));
				},
				reversed: function () {
				...
				statics: {
						...
						if ((r >= s == s >= a && s >= a == a >= o) || T.isStraight(t)) n.push(t);
							...
							if (g) {
								...
								var v = _[0],
									p = T.subdivide(t, v);
								n.push(p[0]),
									g > 1 && ((v = (_[1] - v) / (1 - v)), (p = T.subdivide(p[1], v)), n.push(p[0])),
									n.push(p[1]);
							} else n.push(t);
						}
						return n;
					...
					getTimeOf: function (t, e) {
						...
						if (null === a)
							for (var o = [e.x, e.y], h = [], u = 0; u < 2; u++)
								for (var l = T.solveCubic(t, u, o[u], h, 0, 1), f = 0; f < l; f++) {
									var d = h[f];
					...
					getBounds: function (t) {
						for (var e = t.slice(0, 2), n = e.slice(), i = [0, 0], r = 0; r < 2; r++)
							T._addBounds(t[r], t[r + 2], t[r + 4], t[r + 6], r, 0, e, n, i);
						...
						if (t < c || e < c || n < c || i < c || t > f || e > f || n > f || i > f)
							if (e < t != e < i && n < t != n < i) l(t, s), l(i, s);
								...
								for (var y = 0; y < v; y++) {
									...
									p <= w &&
										w <= m &&
										l(x * x * x * t + 3 * x * x * w * e + 3 * x * w * w * n + w * w * w * i, s);
								}
							}
					},
				},
			...
			r.each(
				...
				function (t) {
					this[t] = function () {
						...
						return (
							e || (e = this._bounds[t] = L[t]([this._segment1, this._segment2], !1, this._path)),
							e.clone()
						);
					};
				},
			...
			r.each(
				...
				},
				{
					...
					isCollinear: function (t) {
						return (
							t && this.isStraight() && t.isStraight() && this.getLine().isCollinear(t.getLine())
						);
					},
					...
					if (0 === n)
						...
						if (
							(e < C
								...
								: e > S
								? ((g = 3 * (f - h)), (v = 3 * (d - l)))
								: ((g = (3 * y * e + 2 * m) * e + p), (v = (3 * b * e + 2 * x) * e + w)),
							i)
						) {
					...
					statics: {
						classify: function (t) {
							...
							var i = t[0],
								...
								x = "serpentine";
							if (((p *= y), (v *= y), (g *= y), w(p)))
								return w(v) ? n(w(g) ? "line" : "quadratic") : n(x, g / (3 * v));
							var b = 3 * v * v - 4 * p * g;
			...
			new (function () {
				function t(t, e, n, i, r, s, a, o, h) {
					var u = !h && n.getPrevious() === s,
						...
						f = 1 - c;
					if (
						(null == i && (i = n.getTimeOf(r)),
						null !== i &&
							i >= (u ? c : 0) &&
							i <= (l ? f : 1) &&
							(null == a && (a = s.getTimeOf(o)),
							null !== a && a >= (l ? c : 0) && a <= (u ? f : 1)))
					) {
						var d = new z(n, i, r || n.getPointAtTime(i), h),
							_ = new z(s, a, o || s.getPointAtTime(a), h);
						(d._intersection = _), (_._intersection = d), (e && !e(d)) || z.insert(t, d, !0);
					}
				}
				function e(r, s, a, o, h, u, l, c, f, d, _, g, v) {
					...
					var R = d + (_ - d) * p,
						D = d + (_ - d) * y;
					if (Math.max(v - g, D - R) < w) {
						var q = (R + D) / 2,
							V = (g + v) / 2;
						t(h, u, l ? o : a, l ? V : q, null, l ? a : o, l ? q : V, null);
					} else if (((r = T.getPart(r, p, y)), y - p > 0.8))
						if (D - R > v - g) {
							var H = T.subdivide(r, 0.5),
								q = (R + D) / 2;
							(f = e(s, H[0], o, a, h, u, !l, c, f, g, v, R, q)),
								(f = e(s, H[1], o, a, h, u, !l, c, f, g, v, q, D));
						} else {
							var H = T.subdivide(s, 0.5),
								V = (g + v) / 2;
							(f = e(H[0], r, o, a, h, u, !l, c, f, g, V, R, D)),
								(f = e(H[1], r, o, a, h, u, !l, c, f, V, v, R, D));
						}
					else
						f =
							v - g >= w
								? e(s, r, o, a, h, u, !l, c, f, g, v, R, D)
								: e(r, s, a, o, h, u, l, c, f, R, D, g, v);
					return f;
				}
				function n(t, e, n, i) {
					var r,
					...
					if (u * l < 0)
						...
						var c = u / l;
						r = [c >= 2 ? [s, a, h] : c <= 0.5 ? [s, o, h] : [s, a, o, h], [s, h]];
					}
				...
				function s(t, e, n, i, r) {
					...
					for (
						var o = Math.atan2(-r, i), h = Math.sin(o), l = Math.cos(o), f = [], d = [], _ = 0;
						_ < 8;
						_ += 2
					) {
						var g = t[_] - e,
				...
				function h(n, i, r, s, h, u) {
					var l = 1e-12,
						...
						f = Math.max;
					if (
						f(n[0], n[2], n[4], n[6]) + l > c(i[0], i[2], i[4], i[6]) &&
						c(n[0], n[2], n[4], n[6]) - l < f(i[0], i[2], i[4], i[6]) &&
						f(n[1], n[3], n[5], n[7]) + l > c(i[1], i[3], i[5], i[7]) &&
						c(n[1], n[3], n[5], n[7]) - l < f(i[1], i[3], i[5], i[7])
					) {
						var _ = d(n, i);
						if (_)
							for (var g = 0; g < 2; g++) {
								var v = _[g];
								t(h, u, r, v[0], null, s, v[1], null, !0);
							}
						else {
				...
				function d(t, e) {
					...
					var i = Math.abs,
						...
						v = f[6] - _,
						p = f[7] - g;
					if (r(_, g, v, p, d[0], d[1], !0) < a && r(_, g, v, p, d[6], d[7], !0) < a)
						!u &&
					...
					for (var y = [t, e], w = [], x = 0; x < 4 && w.length < 2; x++) {
						var b = 1 & x,
							C = 1 ^ b,
							S = x >> 1,
							k = T.getTimeOf(y[b], new c(y[C][S ? 6 : 0], y[C][S ? 7 : 1]));
						if (null != k) {
							var I = b ? [S, k] : [k, S];
		...
		z = r.extend(
			{
				...
				getSegment: function () {
					...
					if (!t) {
						...
						0 === n
							...
							? (t = e._segment2)
							: null != n &&
							  (t = e.getPartLength(0, n) < e.getPartLength(n, 1) ? e._segment1 : e._segment2),
							(this._segment = t);
					}
					return t;
				},
				...
				isCrossing: function () {
					...
					if ((i > a && (u = u.getNext()), r > a && (c = c.getNext()), !(l && u && f && c)))
						return !1;
					var d = [];
				...
				function t(t, e, n) {
					...
					for (var r = t.length, s = 0, a = r - 1; s <= a; ) {
						...
						if (n && (o = e.equals(u) ? u : i(h, -1) || i(h, 1)))
							return e._overlap && (o._overlap = o._intersection._overlap = !0), o;
						var l = e.getPath(),
							c = u.getPath(),
							f =
								l !== c ? l._id - c._id : e.getIndex() + e.getTime() - (u.getIndex() + u.getTime());
						f < 0 ? (a = h - 1) : (s = h + 1);
					}
		...
		O = w.extend({
			...
			_contains: function (t) {
				...
				return (
					e.onPath ||
					!!("evenodd" === this.getFillRule() ? 1 & e.windingL || 1 & e.windingR : e.winding)
				);
			},
			getIntersections: function (t, e, n, i) {
				...
				return r || this.getBounds(s).touches(t.getBounds(a))
					? T.getIntersections(this.getCurves(), !r && t.getCurves(), e, s, a, i)
					: [];
			},
			...
			getNearestLocation: function () {
				for (
					var t = c.read(arguments), e = this.getCurves(), n = 1 / 0, i = null, r = 0, s = e.length;
					r < s;
					r++
				) {
			...
			interpolate: function (t, e, n) {
				...
				var h = o.length,
					u = a.length;
				if (h < u) for (var l = i ? A : L, c = h; c < u; c++) this.add(new l());
		...
		L = O.extend(
				...
				initialize: function (t) {
					...
					n && n.length > 0
						...
						: ((this._curves = e),
						  ...
						  n || "string" != typeof t || (this.setPathData(t), (t = null))),
			...
			},
			{
				...
				getPathData: function (t, e) {
					function n(e, n) {
						if ((e._transformCoordinates(t, g), (i = g[0]), (r = g[1]), v))
							...
							if (!n) {
								var h = i - s,
									f = r - a;
								p.push(
									0 === h ? "v" + _.number(f) : 0 === f ? "h" + _.number(h) : "l" + _.pair(h, f)
								);
							}
						} else
							p.push(
								"c" + _.pair(l - s, c - a) + " " + _.pair(o - s, u - a) + " " + _.pair(i - s, r - a)
							);
						(s = i), (a = r), (l = g[4]), (c = g[5]);
					}
					var i,
				...
				splitAt: function (t) {
					...
					if (n >= 0 && n < a.length) {
						...
						var o,
							h = this.removeSegments(n, this._segments.length, !0);
						return (
							this._closed
								? (this.setClosed(!1), (o = this))
								: ((o = new L(w.NO_INSERT)), o.insertAbove(this), o.copyAttributes(this)),
							o._add(h, 0),
							this.addSegment(h[0]),
							o
						);
				...
				split: function (t, n) {
					var i,
						r = n === e ? t : (i = this.getCurves()[t]) && i.getLocationAtTime(n);
						...
						if (r && r._point.isClose(a._point, n))
							...
							o && o._point.isClose(a._point, n) && t.reverse(),
								...
								o && o._point.isClose(s._point, n)
									? (o.setHandleIn(s._handleIn), this._add(i.slice(0, i.length - 1), 0))
									: this._add(i.slice());
						}
				...
				reduce: function (t) {
					for (
						var e = this.getCurves(), n = t && t.simplify, i = n ? 1e-7 : 0, r = e.length - 1;
						r >= 0;
						r--
					) {
						var s = e[r];
				...
				flatten: function (t) {
					for (
						var e = new N(this, t || 0.25, 256, !0), n = e.parts, i = n.length, r = [], s = 0;
						s < i;
						s++
					)
				...
				smooth: function (t) {
					function n(t, e) {
						...
						if (null != n) {
							var r = t.path;
							if (r && r !== i)
								throw new Error(t._class + " " + n + " of " + r + " is not part of " + i);
							e && t instanceof T && n++;
					...
					if (/^(?:asymmetric|continuous)$/.test(s)) {
						...
						for (
							...
							var L = x < I,
								...
								F = E / k;
							(k = M[x] = N - F),
								(C = P[x] = B * w[x]._x + j * w[x + 1]._x - F * C),
								(S = A[x] = B * w[x]._y + j * w[x + 1]._y - F * S);
						}
						(z[I] = P[I] / M[I]), (O[I] = A[I] / M[I]);
						for (var x = v - 2; x >= 0; x--)
							(z[x] = (P[x] - z[x + 1]) / M[x]), (O[x] = (A[x] - O[x + 1]) / M[x]);
				...
				toShape: function (t) {
					function n(t, e) {
						...
						return (
							...
							r._handleOut.isZero() &&
							s._handleIn.isZero() &&
							i._point.subtract(n._point).isCollinear(s._point.subtract(r._point))
						);
					}
					function i(t) {
						var e = c[t],
						...
						return (
							...
							e._handleOut.isZero() &&
							i._handleIn.isZero() &&
							e._point.subtract(n._point).isOrthogonal(i._point.subtract(e._point))
						);
					}
					function r(t) {
						var e = c[t],
						...
						if (i.isOrthogonal(r)) {
							var a = e._point,
								o = n._point,
								h = new m(a, i, !0).intersect(new m(o, r, !0), !0);
							return (
								h &&
								u.isZero(i.getLength() / h.subtract(a).getLength() - s) &&
								u.isZero(r.getLength() / h.subtract(o).getLength() - s)
							);
						}
						return !1;
					}
					...
					var a,
						...
						c = this._segments;
					if (
						(!this.hasHandles() && 4 === c.length && n(0, 2) && n(1, 3) && i(1)
							? ((a = C.Rectangle),
							  (o = new d(s(0, 3), s(0, 1))),
							  (l = c[1]._point.add(c[2]._point).divide(2)))
							: 8 === c.length && r(0) && r(2) && r(4) && r(6) && n(1, 5) && n(3, 7)
							? ((a = C.Rectangle),
							  (o = new d(s(1, 6), s(0, 3))),
							  (h = o.subtract(new d(s(0, 7), s(1, 2))).divide(2)),
							...
							: 4 === c.length &&
							  ...
							  (u.isZero(s(0, 2) - s(1, 3))
									...
									: ((a = C.Ellipse), (h = new d(s(2, 0) / 2, s(3, 1) / 2))),
							  (l = c[1]._point)),
						a)
					) {
						var f = this.getPosition(!0),
							_ = new a({ center: f, size: o, radius: h, insert: !1 });
						return (
							...
							if (g(p - l) < v) {
								...
								if (g(m - a) < v) {
									if (
										(_ || (_ = [s, m]),
										(a = d[1][1]),
										1 === a && (++s >= r && (s = 0), (f = h[s] || n[s].getValues()), (a = 0)),
										!o)
									)
										return _[0] === s && _[1] === a;
									continue;
				...
				_hitTestSelf: function (t, e, n, i) {
					...
					function a(t, n) {
						return (
							...
							(!n &&
								e.handles &&
								(s(t, t._handleIn, "handle-in") || s(t, t._handleOut, "handle-out")))
						);
					}
					function o(t) {
						f.add(t);
					...
					function h(e) {
						...
						if (
							...
							n
								? e.isSmooth() || L._addBevelJoin(e, u, k, c, null, i, o, !0)
								: "square" === l && L._addSquareCap(e, l, k, null, i, o, !0),
							!f.isEmpty())
						) {
							var s;
					...
					return (!d && C && this._contains(t)) || (d && !b && !S)
						? new P("fill", this)
						: d
						? new P(b ? "stroke" : "curve", this, { location: d, point: d.getPoint() })
						: null;
				},
			},
			r.each(
			...
			new (function () {
				...
				return {
					_draw: function (t, n, i, r) {
						...
						if (
							(a || t.beginPath(),
							(u || (l && !f) || o) && (e(t, this, r), this._closed && t.closePath()),
							!o &&
								(u || l) &&
								(this._setStyles(t, n, i),
								u && (t.fill(h.getFillRule()), (t.shadowColor = "rgba(0,0,0,0)")),
								l))
						) {
							if (f) {
								a || t.beginPath();
					...
					curveTo: function () {
						var e = c.read(arguments),
							...
							o = e
								...
								.divide(2 * i * s);
						if (o.isNaN())
							throw new Error("Cannot put a curve through points with parameter = " + i);
					...
					arcTo: function () {
						...
						if ("boolean" == typeof v)
							...
							(n = new c((P * I) / M, (-M * k) / P)
								...
								.rotate(b)
								.add(y)),
								(a = new p().translate(n).rotate(b).scale(P, M)),
								(s = a._inverseTransform(f)),
								(i = s.getDirectedAngle(a._inverseTransform(_))),
						...
						for (
							var D = 1e-12,
								q = o(i),
								V = q >= 360 ? 4 : Math.ceil((q - D) / 90),
								H = i / V,
								U = (H * Math.PI) / 360,
								Z = ((4 / 3) * Math.sin(U)) / (1 + Math.cos(U)),
								W = [],
								$ = 0;
							$ <= V;
							$++
							...
							if (
								($ < V &&
									...
									a
										? ((S = a._transformPoint(s)), (G = a._transformPoint(s.add(G)).subtract(S)))
										: (S = n.add(s))),
								$)
							) {
				...
				statics: {
					getBounds: function (t, e, n, i, r, s) {
						function a(t) {
							...
							for (var e = 0; e < 2; e++)
								T._addBounds(u[e], u[e + 4], h[e + 2], h[e], e, s ? s[e] : 0, l, c, f);
							var n = u;
							(u = h), (h = n);
						}
						var o = t[0];
					...
					_addBevelJoin: function (t, e, n, i, r, s, a, o) {
						...
						if (
							(f.getDirectedAngle(d) < 0 && ((f = f.negate()), (d = d.negate())),
							o && a(l),
							a(l.add(f)),
							"miter" === e)
						) {
					...
					_addSquareCap: function (t, e, n, i, r, s, a) {
						...
						"square" === e &&
							...
							(o = o.add(u.rotate(0 === h.getTime() ? -90 : 90)))),
							s(o.add(u)),
							s(o.subtract(u));
					},
					getHandleBounds: function (t, e, n, i, r) {
						...
						if (h) {
							var u = n._getStrokeMatrix(i, r),
								...
								c = l;
							"miter" === o.getStrokeJoin() && (c = l * o.getMiterLimit()),
								"square" === o.getStrokeCap() && (c = Math.max(c, l * Math.SQRT2)),
								(s = L._getStrokePadding(l, u)),
								(a = L._getStrokePadding(c, u));
						}
						for (
							var f = new Array(6), d = 1 / 0, _ = -d, v = d, p = _, m = 0, y = t.length;
							m < y;
							m++
						) {
							var w = t[m];
	...
	L.inject({
		statics: new (function () {
			function t(t, e, n) {
				var i = r.getNamed(n),
					s = new L(i && i.insert === !1 && w.NO_INSERT);
			...
			return {
				Line: function () {
					return t(
						[new A(c.readNamed(arguments, "from")), new A(c.readNamed(arguments, "to"))],
						!1,
						arguments
					);
				},
				...
				Star: function () {
					for (
						...
						h[u] = new A(e.add(o.rotate(a * u).multiply(u % 2 ? s : i)));
	...
	var E = O.extend(
		{
				...
				for (var s = e.length - 1; s >= 0; s--) {
					...
					n !== e || a instanceof L || (n = r.slice(n)),
						Array.isArray(a)
							...
							: a instanceof E &&
							  (n.splice.apply(n, [s, 1].concat(a.removeChildren())), a.remove());
				}
			...
			_hitTestChildren: function xt(t, e, n) {
				return xt.base.call(
					this,
					t,
					e["class"] === L || "path" === e.type ? e : r.set({}, e, { fill: !1 }),
					n
				);
			},
			_draw: function (t, e, n, i) {
				...
				if (r.length) {
					...
					if (!e.clip) {
						this._setStyles(t, e, n);
						var o = this._style;
						o.hasFill() && (t.fill(o.getFillRule()), (t.shadowColor = "rgba(0,0,0,0)")),
	...
	O.inject(
		new (function () {
			...
			function n(t, e, n, i, r, s) {
				...
				return (
					a.addChildren(e, !0),
					n && (a = a.reduce({ simplify: !0 })),
					(s && s.insert === !1) ||
						a.insertAbove(r && i.isSibling(r) && i.getIndex() < r.getIndex() ? r : i),
					a.copyAttributes(i, !0),
					a
				);
			}
			function i(e, i, r, a) {
			...
			function s(e, i, r) {
				...
				for (var a = t(e), o = t(i), h = a.getCrossings(o), u = [], l = h.length - 1; l >= 0; l--) {
					var c = h[l].split();
					c &&
						(s(c) && c.getFirstSegment().setHandleIn(0, 0), a.getLastSegment().setHandleOut(0, 0));
				}
			...
			function h(t, e, n) {
				...
				if (i) {
					...
					for (var h = 0; h < i; h++) {
						for (
							var u = a[h], l = s[u._id], c = u.getInteriorPoint(), f = 0, d = h - 1;
							d >= 0;
							d--
						) {
							var _ = a[d];
			...
			function l(t, e, n) {
				...
				for (var g = t.length - 1; g >= 0; g--) {
					...
					if (
						(v &&
							(v !== s
								? ((f = !v.hasHandles() || (_ && _[i(v)])), (r = []), (h = null), (s = v))
								: h >= l && (y /= h)),
						x)
					)
						r && r.push(m);
			...
			function c(t, e, n, i, r) {
				function s(s) {
					...
					if (!(p < _(a, h) || p > g(a, h))) {
						var f = s[u + 0],
							...
							m = s[u + 4],
							P = s[u + 6];
						if (a === h) return void (((f < x && P > w) || (P < x && f > w)) && (S = !0));
						var A =
								p === a
									? 0
									: p === h
									? 1
									: w > g(f, v, m, P) || x < _(f, v, m, P)
									? 1
									: 1 === T.solveCubic(s, l, p, I, 0, 1)
									? I[0]
									: 0.5,
					...
					if (p <= g(e, i, r, a) && p >= _(e, i, r, a))
						for (
							var o,
								...
								f = t[u + 4],
								d = t[u + 6],
								v = w > g(h, c, f, d) || x < _(h, c, f, d) ? [t] : T.getMonoCurves(t, n),
								m = 0,
								y = v.length;
							m < y;
							m++
				...
				for (
					...
					if (
						!(
							...
							((o = null),
							O._closed ||
								((h = T.getValues(O.getLastCurve().getSegment2(), z.getSegment1(), null, !i)),
								h[l] !== h[l + 6] && (o = h)),
							o)
						)
					) {
						o = L;
						for (var E = O.getLastCurve(); E && E !== z; ) {
							var N = E.getValues();
							if (N[l] !== N[l + 6]) {
								o = N;
								break;
				...
				return (
					(b = v(b)),
					(C = v(C)),
					{ winding: g(b, C), windingL: b, windingR: C, quality: k, onPath: S }
				);
			}
			function f(t, e, n, i, r) {
				...
				for (
					var d = [0.5, 0.25, 0.75],
						_ = { winding: 0, quality: 0 },
						s = _,
						g = 1e-8,
						p = 1 - g,
						m = 0;
					m < d.length && s.quality < 0.5;
					m++
				)
					for (var f = h * d[m], y = 0, w = a.length; y < w; y++) {
						var x = a[y],
							b = x.length;
						if (f <= b) {
							var l = x.curve,
								C = l._path,
								S = C._parent,
								k = u.clamp(l.getTimeAt(f), g, p),
								I = l.getPointAtTime(k),
								P = v(l.getTangentAtTime(k).normalize().y) < Math.SQRT1_2 ? 1 : 0;
							S instanceof E && (C = S);
							var A =
								r.subtract &&
								n &&
								((C === e && n._getWinding(I, P, !0).winding) ||
									(C === n && !e._getWinding(I, P, !0).winding))
									? _
									: c(I, i, P, !0);
				...
				for (var y = a.length - 1; y >= 0; y--) a[y].segment._winding = s;
			}
			function d(t, e) {
				function n(t) {
					var n;
					return !(
						...
						(e &&
							(!e[(n = t._winding || {}).winding] ||
								(e.unite && 2 === n.winding && n.windingL && n.windingR)))
					);
				}
				function i(t) {
					...
					function r(r, s) {
						for (; r && r !== s; ) {
							var o = r._segment,
								...
								c = l && l._intersection;
							o !== t &&
								(i(o) || i(l) || (l && n(o) && (n(l) || (c && n(c._segment))))) &&
								h.push(o),
								e && a.push(o),
								(r = r._next);
						}
				...
				for (var h = 0, u = t.length; h < u; h++) {
					...
					for (; _; ) {
						...
						if (
							...
							l ||
								(k && C.push(d),
								(l = { start: g._segments.length, crossings: C, visited: (c = []), handleIn: f })),
							k && (d = S),
							!n(d))
						) {
							...
							do
								(d = l && l.crossings.shift()),
									d || ((l = m.pop()), l && ((c = l.visited), (f = l.handleIn)));
							while (l && !n(d));
							if (!d) break;
						}
						var M = d.getNext();
					...
					v &&
						(p && (g.firstSegment.setHandleIn(f), g.setClosed(p)), 0 !== g.getArea() && o.push(g));
				}
				return o;
			}
			var _ = Math.min,
			...
			return {
				...
				resolveCrossings: function () {
					...
					if (((a = z.expand(a)), i))
						for (
							...
							t(_) &&
								...
								_ === f || _.getCurve().hasLength() || (g._handleIn.set(_._handleIn), _.remove()));
						}
					s &&
						(l(
							a,
							i &&
								function (t) {
									...
									return (
										!!(e && r && e._path && r._path) ||
										(n && (n._intersection = null), void (s && (s._intersection = null)))
									);
								},
							h
						),
					...
					return (
						p > 1 && e
							...
							: 1 !== p ||
							  e ||
							  (n[0] !== this && this.setSegments(n[0].removeSegments()), (v = this)),
						v ||
							((v = new E(w.NO_INSERT)),
							v.addChildren(n),
							(v = v.reduce()),
				...
				getInteriorPoint: function () {
					...
					if (!this.contains(e)) {
						for (
							var n = this.getCurves(), i = e.y, r = [], s = [], a = 0, o = n.length;
							a < o;
							a++
						) {
							var h = n[a].getValues(),
	...
	var N = r.extend(
			{
				...
				initialize: function (t, e, n, i, r) {
					...
					function a(t, n, r, s) {
						if (!(s - r > c) || (i && T.isStraight(t)) || T.isFlatEnough(t, e || 0.25)) {
							var o = t[6] - t[0],
								h = t[7] - t[1],
								f = Math.sqrt(o * o + h * h);
		...
		B = r.extend({
			initialize: function (t) {
				for (
					var e, n = (this.points = []), i = t._segments, r = t._closed, s = 0, a = i.length;
					s < a;
					s++
				) {
					var o = i[s].point;
			...
			fit: function (t) {
				...
				return (
					n > 0 &&
						((i = [new A(e[0])]),
						n > 1 &&
							(this.fitCubic(i, t, 0, n - 1, e[1].subtract(e[0]), e[n - 2].subtract(e[n - 1])),
			...
			fitCubic: function (t, e, n, i, r, s) {
				...
				for (
					var l, c = this.chordLengthParameterize(n, i), f = Math.max(e, e * e), d = !0, _ = 0;
					_ <= 4;
					_++
				) {
			...
			generateBezier: function (t, e, n, i, r) {
				...
				if (S < E || k < E) S = k = L / 3;
					...
					(z = i.normalize(S)),
						(O = r.normalize(k)),
						z.dot(N) - O.dot(N) > L * L && ((S = k = L / 3), (z = O = null));
				}
			...
			new (function () {
				function t(t) {
					...
					if (r) {
						...
						var u = a[t];
						if (!u) {
							e || ((e = tt.getContext(1, 1)), (e.globalCompositeOperation = "copy")),
						...
						(s[e] = []),
							r.each(
								...
								function (t, n) {
										...
										h = (s[e][n] =
											"gradient" === t
												? function (t) {
														...
														return (
															(t = D.read(Array.isArray(t) ? t : arguments, 0, { readNull: !0 })),
									...
									(this["get" + a] = function () {
										return this._type === e || (o && /^hs[bl]$/.test(this._type))
											? this._components[n]
											: this._convert(e)[n];
									}),
										(this["set" + a] = function (t) {
											this._type === e ||
												...
												(this._type = e)),
												(this._components[n] = h.call(this, t)),
												this._changed();
										});
								},
								this
					...
					},
					{
						...
						initialize: function l(e) {
							...
							if (
								("string" === d &&
									...
									Array.isArray(e)
										? ((a = e), (o = u[2]))
										: (c && (f = 1), (u = r.slice(u, 1)), (d = typeof e))),
								!a)
							) {
								if ((h = "number" === d ? u : "object" === d && null != e.length ? e : null)) {
									...
									var _ = i[n].length;
									(o = h[_]),
										c && (f += h === arguments ? _ + (null != o ? 1 : 0) : 1),
										h.length > _ && (h = r.slice(h, 0, _));
								} else if ("string" === d)
									(n = "rgb"), (a = t(e)), 4 === a.length && ((o = a[3]), a.length--);
								else if ("object" === d)
									if (e.constructor === l) {
										if (
											((n = e._type), (a = e._components.slice()), (o = e._alpha), "gradient" === n)
										)
											for (var g = 1, v = a.length; g < v; g++) {
												var p = a[g];
												p && (a[g] = p.clone());
											}
									} else if (e.constructor === D) (n = "gradient"), (h = u);
									else {
										n =
											"hue" in e
												? "lightness" in e
										...
										for (var g = 0, v = m.length; g < v; g++) {
											...
											null == w &&
												...
												"gradient" === n &&
												"stops" in e &&
												(w = { stops: e.stops, radial: e.radial }),
												(w = y[g].call(this, w)),
												null != w && (a[g] = w);
										}
										o = e.alpha;
						...
						_convert: function (t) {
							...
							return this._type === t
								...
								: u["rgb-" + t].apply(this, u[this._type + "-rgb"].apply(this, this._components));
						},
						convert: function (t) {
						...
						toString: function () {
							...
							return (
								null != this._alpha && e.push("alpha: " + i.number(this._alpha)),
								"{ " + e.join(", ") + " }"
							);
						},
						toCSS: function (t) {
						...
						toCanvasStyle: function (t) {
							...
							if (i._radial) {
								...
								if (h) {
									var u = h.subtract(s);
									u.getLength() > o && (h = s.add(u.normalize(o - 0.1)));
								}
								var l = h || s;
				...
				return r.each(
					...
					function (t, e) {
						this[e] = function (e) {
							e = R.read(arguments);
							for (
								var n = this._type, i = this._components, r = e._convert(n), s = 0, a = i.length;
								s < a;
								s++
							)
								r[s] = t(i[s], r[s]);
		...
		V = r.extend(
					...
					o = {
						...
						initialize: function (e, r, s) {
							(this._values = {}),
								...
								(this._defaults = !r || r instanceof x ? n : r instanceof j ? i : t),
								e && this.set(e);
						},
					};
				return (
						...
						(o[f] = function (t) {
							...
							if (s && s.length > 0 && !(r instanceof E))
								...
								h !== t &&
									(i &&
										...
										t && t.constructor === R && (t._owner && (t = t.clone()), (t._owner = r))),
									(this._values[n] = t),
									r && r._changed(l || 65));
							}
						}),
							(o[d] = function (t) {
								...
								if (n in this._defaults && (!o || !o.length || t || a instanceof E)) {
									...
									if (s === e) (s = this._defaults[n]), s && s.clone && (s = s.clone());
									else {
										var u = i ? R : h ? c : null;
										!u ||
											(s && s.constructor === u) ||
											((this._values[n] = s = u.read([s], 0, { readNull: !0, clone: !0 })),
											s && i && (s._owner = a));
									}
								} else if (o)
			...
			})(),
			{
				...
				equals: function (t) {
					...
					return (
						t === this || (t && this._class === t._class && n(this, t) && n(t, this, !0)) || !1
					);
				},
				hasFill: function () {
				...
				hasShadow: function () {
					...
					return (
						!!t && t.alpha > 0 && (this.getShadowBlur() > 0 || !this.getShadowOffset().isZero())
					);
				},
				getView: function () {
					return this._project._view;
				...
				getLeading: function bt() {
					var t = bt.base.call(this),
						e = this.getFontSize();
					return (
						/pt|em|%|px/.test(e) && (e = this.getView().getPixelSize(e)), null != t ? t : 1.2 * e
					);
				},
			}
		),
	...
	U.requestAnimationFrame = new (function () {
		...
		var e,
			i = H.getPrefixed(n, "requestAnimationFrame"),
			r = !1,
			s = [];
		return function (n) {
	...
	var Z = r.extend(
			s,
			{
				...
				initialize: function Ct(t, e) {
					...
					if (n && e) {
						(this._id = e.getAttribute("id")),
							null == this._id && e.setAttribute("id", (this._id = "view-" + Ct._id++)),
							U.add(e, this._viewEvents);
						var h = "none";
						if (
							(H.setPrefixed(e.style, {
								userDrag: h,
								userSelect: h,
								touchCallout: h,
								contentZooming: h,
				...
				remove: function () {
					...
					return (
						...
						U.remove(this._element, this._viewEvents),
						U.remove(n, this._windowEvents),
					...
					if (!this._requested) {
						...
						U.requestAnimationFrame(function () {
							if (((t._requested = !1), t._animate)) {
								t.requestUpdate();
								var e = t._element;
								(H.getPrefixed(i, "hidden") && "true" !== a.getAttribute(e, "keepalive")) ||
									!H.isInView(e) ||
									t._handleFrame();
							}
				...
				_handleFrame: function () {
					...
					(this._last = t),
						this.emit("frame", new r({ delta: e, time: (this._time += e), count: this._count++ })),
				...
				_animateItem: function (t, e) {
					...
					e
						? ((n[t._id] = { item: t, time: 0, count: 0 }),
						  1 === ++this._frameItemCount && this.on("frame", this._handleFrameItems))
						: (delete n[t._id],
			...
			new (function () {
				...
				function s(t, e, n, i, r, s, a) {
					function o(t, n) {
						if (t.responds(n)) {
							if (
								(h || (h = new X(n, i, r, e || t, s ? r.subtract(s) : null)),
								t.emit(n, h) && ((I = !0), h.prevented && (P = !0), h.stopped))
							)
								return (u = !0);
						} else {
							var a = A[n];
				...
				function a(t, e, n, i, r, a) {
					return (
						...
						(P = I = !1),
						(b && s(b, null, n, i, r, a)) ||
							(e && e !== b && !e.isDescendant(b) && s(e, null, A[n] || n, i, r, a, b)) ||
							s(t, b || e || t, n, i, r, a)
					);
				}
				if (n) {
					...
					_.pointerEnabled || _.msPointerEnabled
						...
						: ((u = "touchstart"),
						  ...
						  ("ontouchstart" in n &&
								_.userAgent.match(/mobile|tablet|ip(ad|hone|od)|android|silk/i)) ||
					...
					(g[u] = function (e) {
						...
						(v[l] = function (n) {
							...
							if (!d) {
								var s = t(n);
								s
									? i !== s && (i && r(i, n), o || (o = i), (i = Z._focused = h = s))
									: h &&
									  h === i &&
									  (o && !o.isInserted() && (o = null), (i = Z._focused = o), (o = null), e());
							}
							i && r(i, n);
						}),
						(v[u] = function () {
						...
						_handleMouseEvent: function (t, e, n) {
							...
							(v[t.substr(5)] = !0),
								o &&
									...
									(x = _)),
								M ^ c &&
									(s(this, null, c ? "mouseenter" : "mouseleave", e, n),
									(p = c ? this : null),
									(g = !0)),
								(!c && !v.drag) ||
									n.equals(y) ||
									(a(this, _, h ? t : "mousemove", e, n, y), (g = !0)),
								(M = c),
								((v.down && c) || (v.up && m)) &&
									(a(this, _, t, e, n, m),
									v.down
										? ((k = _ === C && Date.now() - S < 300), (w = C = _), (b = !P && _), (m = n))
										: v.up &&
										  (P ||
												_ !== w ||
												((S = Date.now()),
												a(this, _, k ? "doubleclick" : "click", e, n, m),
												(k = !1)),
										  (w = b = null)),
									(M = !1),
									(g = !0)),
								(y = n),
								g && u && (I = u._handleMouseEvent(t, e, n, v) || I),
								((I && !v.move) || (v.down && i("mouseup"))) && e.preventDefault();
						},
		...
		W = Z.extend({
			...
			initialize: function (t, e) {
				if (!(e instanceof n.HTMLCanvasElement)) {
					...
					if (i.isZero())
						throw new Error(
							"Cannot create CanvasView with the provided argument: " + r.slice(arguments, 1)
						);
					e = tt.getCanvas(i);
				}
		...
		J = new (function () {
			...
			var s,
				...
				u = {},
				l = {},
				c = new r({ shift: !1, control: !1, alt: !1, meta: !1, capsLock: !1, space: !1 }).inject({
					option: {
						get: function () {
							return this.alt;
						},
				...
				U.add(i, {
					keydown: function (n) {
						var i = t(n),
							r = paper && paper.agent;
						i.length > 1 ||
						(r && r.chrome && (n.altKey || (r.mac && n.metaKey) || (!r.mac && n.ctrlKey)))
			...
			_handleMouseEvent: function (t, e, n, i) {
				function r(t, e) {
					...
					return (
						(c._point = r),
						(c._lastPoint = s || r),
						i.down && ((c._moveCount = -1), (c._downPoint = r), c._downCount++),
						!0
					);
				}
				function s() {
		...
		Q = {
			request: function (e) {
				...
				return (
					n.open((e.method || "get").toUpperCase(), e.url, r.pick(e.async, !0)),
					...
					try {
						(x.fillStyle = n ? "#300" : "#a00"),
							...
							x.globalCompositeOperation === e &&
								...
								x.fillRect(0, 0, 1, 1),
								(i = x.getImageData(0, 0, 1, 1).data[0] !== n ? 170 : 51));
					} catch (r) {}
					x.restore(), (w[e] = i);
				}),
				tt.release(x)),
	...
	return (
		new (function () {
				...
				if (!t.isIdentity()) {
					...
					if (o) {
						var h = [],
							...
							c = o.scaling,
							f = o.skewing;
						s && !s.isZero() && h.push("translate(" + S.point(s) + ")"),
							l && h.push("rotate(" + S.number(l) + ")"),
							(u.isZero(c.x - 1) && u.isZero(c.y - 1)) || h.push("scale(" + S.point(c) + ")"),
							f && f.x && h.push("skewX(" + S.number(f.x) + ")"),
							f && f.y && h.push("skewY(" + S.number(f.y) + ")"),
							(i.transform = h.join(" "));
			...
			function n(t, n) {
				for (
					var i = e(t._matrix), r = t._children, s = nt.create("g", i, S), a = 0, o = r.length;
					a < o;
					a++
				) {
					var h = r[a],
			...
			function i(t, n) {
				...
				return (
					...
					(i.width = r.width),
					(i.height = r.height),
					(i.href = (n.embedImages === !1 && s && s.src) || t.toDataURL()),
					nt.create("image", i, S)
				);
			}
			function s(t, n) {
			...
			function f(t) {
				...
				if (!e) {
					...
					(n.gradientUnits = "userSpaceOnUse"),
						(e = nt.create((r ? "radial" : "linear") + "Gradient", n, S));
				...
				if (k) {
					...
					for (var s in k.svgs)
						r ||
							...
							(r = i.insertBefore(nt.create("defs"), i.firstChild))),
		...
		new (function () {
			function s(t, e, n, i, r) {
				...
				return /%\s*$/.test(s)
					? (a / 100) * (r ? 1 : T[/x|^width/.test(e) ? "width" : "height"])
					: a;
			}
			...
			function l(t, e) {
				for (
					var n = t.getAttribute("points").match(/[+-]?(?:\d*\.\d+|\d+\.?)(?:[eE][+-]?\d+)?/g),
						i = [],
						r = 0,
						s = n.length;
					r < s;
			...
			function _(t, e) {
				...
				var v = k(new R(n, f, d, _), t);
				return (v._scaleToBounds = g), null;
			}
			function v(t, e, n, i) {
				if (t.transform) {
					for (
						var r = (i.getAttribute(n) || "").split(/\)\s*/g), s = new p(), a = 0, o = r.length;
						a < o;
						a++
					) {
						var h = r[a];
						if (!h) break;
						for (
							var u = h.split(/\(\s*/), l = u[0], c = u[1].split(/[\s,]+/g), f = 0, d = c.length;
							f < d;
							f++
						)
							c[f] = parseFloat(c[f]);
			...
			function A(t, e, n) {
				...
				n &&
					l &&
					((T = o(t, null, null, !0) || paper.getView().getSize()),
					(s = nt.create("svg", { style: "stroke-width: 1px; stroke-miterlimit: 10" })),
					(a = t.parentNode),
					(h = t.nextSibling),
					s.appendChild(t),
					c.appendChild(s));
				...
				return (
					s && (c.removeChild(s), a && (h ? a.insertBefore(t, h) : a.appendChild(t))),
					n && ((z = {}), v && r.pick(e.applyMatrix, d) && v.matrix.apply(!0, !0)),
					v
				);
			}
			function M(n, r, s) {
				function a(i) {
					try {
						var a =
							"object" == typeof i ? i : new t.DOMParser().parseFromString(i, "image/svg+xml");
		...
		(r.exports.PaperScript = function () {
			...
			function h(e, r) {
				...
				function u(t, n) {
					for (var i = s(t.range[0]), r = s(t.range[1]), a = 0, o = d.length - 1; o >= 0; o--)
						if (i > d[o][0]) {
							a = o + 1;
							break;
						}
					d.splice(a, 0, [i, n.length - r + i]), (e = e.substring(0, i) + n + e.substring(r));
				}
				function l(t, e) {
					if (t) {
						for (var n in t)
							if ("range" !== n && "loc" !== n) {
								var i = t[n];
								if (Array.isArray(i)) for (var r = 0, s = i.length; r < s; r++) l(i[r], t);
								else i && "object" == typeof i && l(i, t);
							}
						switch (t.type) {
							case "UnaryExpression":
								if (t.operator in y && "Literal" !== t.argument.type) {
									var o = a(t.argument);
									u(t, '$__("' + t.operator + '", ' + o + ")");
								}
								break;
							...
							case "AssignmentExpression":
								...
								if (
									!(
										"ForStatement" === g ||
										("BinaryExpression" === g && /^[=!<>]/.test(e.operator)) ||
									...
									if ("UpdateExpression" === t.type) {
										var o = a(t.argument),
											...
											p = o + " = " + v;
										t.prefix ||
											("AssignmentExpression" !== g && "VariableDeclarator" !== g) ||
											(a(e.left || e.id) === o && (p = v), (p = o + "; " + p)),
											u(t, p);
				...
				if (
					w &&
					((g.chrome && v >= 30) || (g.webkit && v >= 537.76) || (g.firefox && v >= 23) || g.node)
				) {
					if (g.node) C -= 2;
					else if (n && _ && !n.location.href.indexOf(_)) {
						var S = i.getElementsByTagName("html")[0].innerHTML;
						C = S.substr(0, S.indexOf(e) + 1).match(b).length + 1;
					}
					p =
						C > 0 &&
						!((g.chrome && v >= 36) || (g.safari && v >= 600) || (g.firefox && v >= 40) || g.node);
					var k = ["AA" + c(p ? 0 : C) + "A"];
					(k.length = (e.match(b) || []).length + 1 + (p ? C : 0)),
						(f = {
							version: 3,
							file: _,
							names: [],
				...
				return (
					l(o(e, { ranges: !0 })),
					f &&
						(p && (e = new Array(C + 1).join("\n") + e),
						/^(inline|both)$/.test(w) &&
							(e +=
								"\n//# sourceMappingURL=data:application/json;base64," +
								t.btoa(unescape(encodeURIComponent(JSON.stringify(f))))),
						(e += "\n//# sourceURL=" + (_ || "paperscript"))),
					{ url: _, source: x, code: e, map: f }
				);
			}
			function u(t, n, a) {
				function o(e, n) {
					for (var i in e)
						(!n && /^_/.test(i)) ||
							!new RegExp("([\\b\\s\\W]|^)" + i.replace(/\$/g, "\\$") + "\\b").test(t) ||
							(g.push(i), v.push(e[i]));
				}
				paper = n;
				var u,
					l = n.getView(),
					f =
						/\btool\.\w+|\s+on(?:Key|Mouse)(?:Up|Down|Move|Drag)\b/.test(t) &&
				...
				(t = p.code),
					o({ __$__: e, $__: s, paper: n, view: l, tool: f }, !0),
					o(n),
					(_ = r
						.each(
							_,
				...
				if (i && (m.chrome || (m.firefox && m.versionNumber < 40))) {
					...
					m.firefox && (t = "\n" + t),
						y.appendChild(i.createTextNode("paper._execute = function(" + g + ") {" + t + "\n}")),
						w.appendChild(y),
						(u = paper._execute),
			...
			var g,
				...
				p = this;
			!(function (t, e) {
				return "object" == typeof g && "object" == typeof module
					? e(g)
				...
				function h() {
					for (
						var t = pt, e = ct.onComment && ct.locations && new r(), n = ft.charCodeAt((pt += 2));
						pt < dt && 10 !== n && 13 !== n && 8232 !== n && 8233 !== n;
				...
				function g(t) {
					var e = ft.charCodeAt(pt + 1);
					return e === t
						? 45 == e && 62 == ft.charCodeAt(pt + 2) && Je.test(ft.slice(At, pt))
							? ((pt += 3), h(), u(), y())
							: w(ke, 2)
						: 61 === e
						? w(Se, 2)
				...
				function v(t) {
					var e = ft.charCodeAt(pt + 1),
						n = 1;
					return e === t
						? ((n = 62 === t && 62 === ft.charCodeAt(pt + 2) ? 3 : 2),
						  61 === ft.charCodeAt(pt + n) ? w(Se, n + 1) : w(Ee, n))
						: 33 == e && 60 == t && 45 == ft.charCodeAt(pt + 2) && 45 == ft.charCodeAt(pt + 3)
						? ((pt += 4), h(), u(), y())
						: (61 === e && (n = 61 === ft.charCodeAt(pt + 2) ? 3 : 2), w(Le, n));
				}
				function p(t) {
					var e = ft.charCodeAt(pt + 1);
				...
				function x() {
					for (var t, e, i = "", r = pt; ; ) {
						...
						var s = ft.charAt(pt);
						if ((Je.test(s) && n(r, "Unterminated regular expression"), t)) t = !1;
						else {
							if ("[" === s) e = !0;
							else if ("]" === s && e) e = !1;
							else if ("/" === s && !e) break;
				...
				function C() {
					...
					var t = b(16);
					return (
						null == t && n(mt + 2, "Expected hexadecimal number"),
						Ye(ft.charCodeAt(pt)) && n(pt, "Identifier directly after number"),
						a(Et, t)
					);
				}
				function S(t) {
					...
					t || null !== b(10) || n(e, "Invalid number"),
						46 === ft.charCodeAt(pt) && (++pt, b(10), (i = !0));
				...
				function k(t) {
					...
					for (var e = ""; ; ) {
						...
						if (92 === i) {
							...
							if (("0" === r && (r = null), ++pt, r))
								Ot && n(pt - 2, "Octal literal in strict mode"),
				...
				function P() {
					...
					for (var t, e = !0, i = pt; ; ) {
						...
						if (Ke(r)) Fe && (t += ft.charAt(pt)), ++pt;
							...
							Fe || (t = ft.slice(i, pt)),
								(Fe = !0),
								117 != ft.charCodeAt(++pt) && n(pt, "Expecting Unicode escape sequence \\uXXXX"),
								++pt;
							var s = I(4),
								a = String.fromCharCode(s);
							a || n(pt - 1, "Invalid Unicode escape"),
								(e ? Ye(s) : Ke(s)) || n(pt - 4, "Invalid Unicode escape"),
								(t += a);
						}
						e = !1;
					}
				...
				function L() {
					...
					return (
						...
						ct.directSourceFile && (t.sourceFile = ct.directSourceFile),
				...
				function E(t) {
					...
					return (
						(e.start = t.start),
						ct.locations && ((e.loc = new O()), (e.loc.start = t.loc.start)),
				...
				function V(t) {
					"Identifier" !== t.type &&
						...
						Ot &&
							"Identifier" === t.type &&
							Ve(t.name) &&
							n(t.start, "Assigning to " + t.name + " in strict mode");
				}
				function H(t) {
				...
				function U() {
					...
					switch (t) {
						...
						case Vt:
							...
							return (
								r === zt.length && n(e.start, "Unsyntactic " + t.keyword),
						...
						case Gt:
							if ((M(), zt.push(Qe), D(ge), bt === me)) return $(e, null);
							if (bt === ee) {
								var a = L();
								return (
									M(),
									...
									1 === a.declarations.length && j(ue) ? G(e, a) : $(e, a)
								);
							}
							var a = X(!1, !0);
						...
						case Xt:
							return (
								...
								(e.test = Z()),
								(e.consequent = U()),
								(e.alternate = j(Wt) ? U() : null),
								N(e, "IfStatement")
							);
						case Yt:
							return (
								Tt || ct.allowReturnOutsideFunction || n(mt, "'return' outside of function"),
								M(),
								j(me) || F() ? (e.argument = null) : ((e.argument = X()), R()),
								N(e, "ReturnStatement")
							);
						case Kt:
							M(), (e.discriminant = Z()), (e.cases = []), D(de), zt.push(tn);
							for (var o, h; bt != _e; )
								if (bt === Dt || bt === Ut) {
									var u = bt === Dt;
									o && N(o, "SwitchCase"),
										...
										u
											? (o.test = X())
											: (h && n(Pt, "Multiple default clauses"), (h = !0), (o.test = null)),
										D(ye);
						...
						case Qt:
							return (
								M(),
								Je.test(ft.slice(At, mt)) && n(At, "Illegal newline after throw"),
								(e.argument = X()),
								R(),
								N(e, "ThrowStatement")
							);
						case te:
							if ((M(), (e.block = W()), (e.handler = null), bt === qt)) {
								...
								M(),
									...
									Ot &&
										Ve(l.param.name) &&
										n(l.param.start, "Binding " + l.param.name + " in strict mode"),
									D(ve),
									(l.guard = null),
									(l.body = W()),
						...
						case ne:
							return (
								M(), (e.test = Z()), zt.push(Qe), (e.body = U()), zt.pop(), N(e, "WhileStatement")
							);
						case ie:
							return (
				...
				function G(t, e) {
					return (
						(t.left = e), (t.right = X()), D(ve), (t.body = U()), zt.pop(), N(t, "ForInStatement")
					);
				}
				function J(t, e) {
					for (t.declarations = [], t.kind = "var"; ; ) {
						...
						if (
							((i.id = lt()),
							Ot && Ve(i.id.name) && n(i.id.start, "Binding " + i.id.name + " in strict mode"),
						...
						return (
							...
							e
								...
								: Ot &&
								  ...
								  n(t.start, "Deleting local variable in strict mode"),
					...
					switch (bt) {
						...
						case ge:
							...
							return (
								(i.start = n),
								(i.end = yt),
								ct.locations && ((i.loc.start = e), (i.loc.end = xt)),
				...
				function st() {
					...
					return (
						M(),
						(t.callee = it(rt(), !0)),
						j(ge) ? (t.arguments = ut(ve, !1)) : (t.arguments = Lt),
						N(t, "NewExpression")
					);
				}
				function at() {
							...
							for (var o = 0; o < t.properties.length; ++o) {
								...
								if (h.key.name === s.key.name) {
									var u =
										r == h.kind ||
										(a && "init" === h.kind) ||
										("init" === r && ("get" === h.kind || "set" === h.kind));
									u && !Ot && "init" === r && "init" === h.kind && (u = !1),
				...
				function ht(t, e) {
					...
					if (
						...
						for (var a = t.id ? -1 : 0; a < t.params.length; ++a) {
							...
							if (
								((qe(o.name) || Ve(o.name)) &&
									n(o.start, "Defining '" + o.name + "' in strict mode"),
								a >= 0)
							)
								for (var h = 0; h < a; ++h)
				...
				function lt(t) {
					var e = L();
					return (
						t && "everywhere" == ct.forbidReserved && (t = !1),
						bt === jt
							? (!t &&
									((ct.forbidReserved && (3 === ct.ecmaVersion ? Re : De)(Ct)) || (Ot && qe(Ct))) &&
									ft.slice(mt, yt).indexOf("\\") == -1 &&
									n(mt, "The keyword '" + Ct + "' is reserved"),
							  (e.name = Ct))
							: t && bt.keyword
							? (e.name = bt.keyword)
							: q(),
				...
				var pt,
					...
					Jt = { keyword: "function" },
					Xt = { keyword: "if" },
					Yt = { keyword: "return", beforeExpr: !0 },
					Kt = { keyword: "switch" },
				...
				var Fe,
					...
					Je = /[\n\r\u2028\u2029]/,
					Xe = /\r\n|[\n\r\u2028\u2029]/g,
					Ye = (t.isIdentifierStart = function (t) {
						return t < 65
							? 36 === t
							: t < 91 ||
									(t < 97 ? 95 === t : t < 123 || (t >= 170 && $e.test(String.fromCharCode(t))));
					}),
							...
							: t < 58 ||
									(!(t < 65) &&
										(t < 91 ||
											(t < 97
												? 95 === t
												: t < 123 || (t >= 170 && Ge.test(String.fromCharCode(t))))));
					}),
					Qe = { kind: "loop" },
					tn = { kind: "switch" };
			});
			...
			return (
				...
				d.inject(w),
				R.inject(w),
				n && ("complete" === i.readyState ? setTimeout(f) : U.add(n, { load: f })),
				{ compile: h, execute: u, load: _, parse: o }
			);
		}.call(this)),
